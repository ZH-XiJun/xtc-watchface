...
import com.xtc.dial.konata.XTCBaseWallpaperService2;
...
public class WallpaperServiceImpl extends XTCBaseWallpaperService2 {
    ...
    @Override // com.xtc.dial.konata.XTCBaseWallpaperService2, com.xtc.common.WallpaperServiceProxy, android.service.wallpaper.WallpaperService
    ...
    public class WonderlandEngine extends XTCBaseWallpaperService2.BaseEngine {
        ...
        @Override // com.xtc.dial.konata.XTCBaseWallpaperService2.BaseEngine, android.service.wallpaper.WallpaperService.Engine
        ...
        @Override // com.xtc.dial.konata.XTCBaseWallpaperService2.BaseEngine, com.xtc.common.callback.IDialCallback
        ...
        public Runnable createRefreshTask() {
            Runnable runnable = new Runnable() { // from class: com.xtc.dial.konata.WallpaperServiceImpl.WonderlandEngine.1
        ...
        public Runnable createAnimationTask() {
            Runnable runnable = new Runnable() { // from class: com.xtc.dial.konata.WallpaperServiceImpl.WonderlandEngine.2
                @Override // java.lang.Runnable
                public void run() {
        ...
        public void onVisibilityChanged(boolean isVisible) {
            ...
            if (this.visible) {
                new Handler().postDelayed(new Runnable() { // from class: com.xtc.dial.konata.WallpaperServiceImpl.WonderlandEngine.3
                    @Override // java.lang.Runnable
                    public void run() {
                        WonderlandEngine.this.drawFrame();
                    }
