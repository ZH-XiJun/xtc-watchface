...
public class XTCBaseWallpaperService2 extends WallpaperServiceProxy {
    ...
    public class BaseEngine extends WallpaperServiceProxy.ActiveEngine implements IDialCallback, Handler.Callback {
        ...
        public BaseEngine() {
            super();
            this.isVisible = true;
            this.timeChangeCallback = new TimeChangeAlarm.ITimeChangeCallback() { // from class: com.xtc.dial.konata.XTCBaseWallpaperService2.BaseEngine.1
            ...
            this.batteryChangedCallback = new StatusHelper.BatteryChangedCallback() { // from class: com.xtc.dial.konata.XTCBaseWallpaperService2.BaseEngine.2
            ...
            this.mStepUpdateListener = new StepUpdateListener() { // from class: com.xtc.dial.konata.XTCBaseWallpaperService2.BaseEngine.3
        ...
        private void initReceiver() {
            ...
            XTCBaseWallpaperService2.this.broadcastReceiver = new BroadcastReceiver() { // from class: com.xtc.dial.konata.XTCBaseWallpaperService2.BaseEngine.4
